...
public static class DnsHelper
{
    ...
    public static bool SetDnsServers(string dns1,string dns2)
    {
        List<string> list = new List<string>();
        list.Add(dns1);
        list.Add(dns2);
        var kk = new System.Collections.ObjectModel.ReadOnlyCollection<string>(list);
        return SetDnsServers(kk);
    }
...
public class InvalidServerException : Exception
{
    ...
    public InvalidServerException(string server, Exception e)
    {
        this.e = e;
        this.server = server;
    }
